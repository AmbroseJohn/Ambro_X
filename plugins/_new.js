let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `AMBRO_X 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VakmvQfLNSa86ho5fq13\n\n ${Config.botname} *©Ambrose John*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*AMBRO_X CURRENTLY ACTIVE!*";
